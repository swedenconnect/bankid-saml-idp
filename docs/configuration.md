...
| `override.show-sp-message` | Tells whether an additional message should be displayed in the UI stating which SP that has requested authentication/signing. Defaults to false. | Boolean                                                                                                                                                           | -                                      |
